...
mdis <- read.table("2018_지상_일_20220718_15746.csv", header=FALSE, sep=",", colClasses = c("character"
...
, "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "character", "numeric", "numeric", "numeric", "numeric", "numeric"
), skip=1, na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))



colnames(mdis) = c("지점번호"
, "지점명", "관측일", "평균기온", "일최고기온", "일최고기온시각", "일최저기온", "일최저기온시각", "일평균이슬점온도", "일평균현지기압", "일최고현지기압", "일최고현지기압시각", "일최저현지기압", "일최저현지기압시각", "일평균해면기압", "일최고해면기압", "일최고해면기압시각", "일최저해면기압", "일최저해면기압시각", "일평균상대습도", "일최소상대습도"
, "일최소상대습도시각", "일평균수증기압", "일최고수증기압", "일최고수증기압시각", "일최저수증기압", "일최저수증기압시각", "일평균풍속", "일합성풍속", "일합성풍향", "일최대풍속", "일최대풍속시각", "일최대풍속풍향", "일최대순간풍속", "일최대순간풍속시각", "일최대순간풍속풍향", "풍정합", "일최다풍향", "일강수량", "10분최다강수량", "10분최다강수량시각"
, "1시간최다강수량", "1시간최다강수량시각", "9_9 강수량", "일최심신적설", "일최심신적설시각", "일최심적설", "일최심적설시각", "합계깊이신적설", "일평균전운량", "일평균중하층운량", "최저운고", "최저운고시각", "최다운량", "최다운량시각", "최다운형", "일합계일조시간", "일합계일사량", "일합계소형증발량", "일합계대형증발량", "일평균지면온도"
)
