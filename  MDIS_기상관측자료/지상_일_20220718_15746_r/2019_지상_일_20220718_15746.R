...
mdis <- read.table("2019_지상_일_20220718_15746.csv", header=FALSE, sep=",", colClasses = c("character"
...
, "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "character", "numeric", "numeric", "numeric", "numeric"), skip=1, na.string=c("*","**","***","****","*****","******","*******","********","*********","**********","."))
...
, "1시간최다강수량시각", "9_9 강수량", "일최심신적설", "일최심신적설시각", "일최심적설", "일최심적설시각", "합계깊이신적설", "일평균전운량", "일평균중하층운량", "최저운고", "최저운고시각", "최다운량", "최다운량시각", "최다운형", "일합계일조시간", "일합계일사량", "일평균지면온도", "일평균이슬점온도")
